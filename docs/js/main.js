...
/* harmony import */ var _components_fancybox_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/fancybox.js */ "./src/js/components/fancybox.js");
...
/* harmony import */ var _components_else_btn_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/else-btn.js */ "./src/js/components/else-btn.js");
/* harmony import */ var _components_success_modal_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/success-modal.js */ "./src/js/components/success-modal.js");
/* harmony import */ var _components_callback_form_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/callback-form.js */ "./src/js/components/callback-form.js");
/* harmony import */ var _components_question_from_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/question-from.js */ "./src/js/components/question-from.js");
/* harmony import */ var _components_sliders_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/sliders.js */ "./src/js/components/sliders.js");
  ...
  rules: [{
    ...
    value: {
      files: {
        ...
        maxSize: 25000,
        minSize: 0,
        types: ["application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint, text/plain, application/pdf, text/txt"]
      }
    },
    errorMessage: "Неверный формат файла, допустимые форматы: pdf, doc, docx, txt, размер файла не должен превышать 25 МБ"
  }]
}];
const afterForm = () => {
  console.log("Произошла отправка, тут можно писать любые действия");
};
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".callback-form", rules1, afterForm);
const rules2 = [{
  ruleSelector: "[type='text']",
  rules: [{
    rule: "required",
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".form-classic--callback", rules2, afterForm);
const rules3 = [{
  ruleSelector: "[type='text']",
  rules: [{
    rule: "required",
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".contacts-form", rules3, afterForm);

/***/ }),

/***/ "./src/js/components/else-btn.js":
/*!***************************************!*\
  !*** ./src/js/components/else-btn.js ***!
  \***************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".question-form", rules1, afterForm);
...
const aboutSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".slider-about", {
...
const laboratorySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".laboratory__slider", {
  slidesPerView: "auto",
  spaceBetween: 12,
  loop: true,
  speed: 800,
...
const certificatesSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".certificate-slider", {
  slidesPerView: "auto",
  spaceBetween: 12,
  speed: 800,
  pagination: {
...
const mailSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".mail-slider", {
  slidesPerView: "auto",
  spaceBetween: 12,
  speed: 800,
  pagination: {
